;-------------------------------- PUERTO K ------------------------------------------
GPIO_PORTBR                   EQU 0x40061004	;GPIO Port B (AHB) 0x40059000 base de datos LECTURA (pin K0)
GPIO_PORTBW                   EQU 0x40061008	;GPIO Port B (AHB) 0x40059000 base de datos ESCRITURA (pin K1)
GPIO_PORTB_DIR_R              EQU 0x40061400	;Offset 0x400=>  0 es entrada, 1 salida
GPIO_PORTB_AFSEL_R            EQU 0x40061420	;Offset 0x420=>  0 funcion como GPIO, 1 funciona como periferico
GPIO_PORTB_DEN_R              EQU 0x4006151C	;Offset 0x51C=>  0 funcina como NO digital, 1 funcion digital
GPIO_PORTB_AMSEL_R            EQU 0x40061528	;Offset 0x528=>  0 Deshabilita funcion analogica, 1 activa analogica
GPIO_PORTB_PCTL_R             EQU 0x4006152C	;Offset 0x52C=>  0 Selecciona funcion alternativa
GPIO_PORTB_ODR_R              EQU 0x4006150C	;Offset 0x50C=>  1 Activa drenador abiertoGPIO_PORTB_LOCK	
...
SYSCTL_RCGCGPIO_R12           EQU 0x00000200  	;1 Enable and provide a clock to GPIO Port B in Run mode K
SYSCTL_PRGPIO_R12             EQU 0x00000200    ;Bandera puerto listo K
...
notOverFlow
	...
	CBNZ R1, OverFlow		;Salta si se desbordo
	B notOverFlow				;Salta si no se desbordo
OverFlow	
	POP {R0,R1,R2}
	BX  LR
